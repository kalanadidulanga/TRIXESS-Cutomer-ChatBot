    ...
    ?>
        ...
        <nav class="navbar homeBody fixed-top">
            <div class="container-fluid">
                ...
                <button class="navbar-toggler navButton border-white text-white" type="button" data-bs-toggle="offcanvas" data-bs-target="#offcanvasNavbar" aria-controls="offcanvasNavbar" aria-label="Toggle navigation">
                ...
                <div class="offcanvas offcanvas-start" tabindex="-1" id="offcanvasNavbar" aria-labelledby="offcanvasNavbarLabel">
                    ...
                    <div class="offcanvas-body d-flex flex-column">
                        ...
                        <button onclick="signout();" class="d-flex p-2 mt-auto col-lg-6 col-10 btn btn-light justify-content-center align-items-center mx-auto">
        ...
        <div class="container homeBody1 d-flex flex-column">
            ...
            <div class="col-12 ms-auto question d-flex justify-content-center align-items-center p-2 my-3">
                <button class="bg-transparent border-0 me-auto ms-2"><img src="images/home/edit.png" width="30px" alt=""></button>
                <input type="text" class="bg-transparent border-0 col-11 text-white text-end pe-3" value="How to Find The Date in Windows Laptop" />
            </div>
        ...
        <div class="container fixed-bottom mb-3 d-flex z-0">
            <div class="col-12 mx-auto questioninput d-flex justify-content-center align-items-center p-2 my-3">
                ...
                <input type="text" class="bg-transparent border-0 col-11 text-white text-start ps-2" value="Ask Something from me" />
                <button class="bg-transparent border-0  ms-auto me-3"><img src="images/home/right-arrow.png" width="30px" alt=""></button>
